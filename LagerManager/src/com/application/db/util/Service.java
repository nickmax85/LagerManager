...
import com.application.db.dao.MailSettingsDAO;
...
public class Service {
	...
	public Mailconfig getMailSetting(int id) {

		try {
			return mailSettingsDAO.get(id);
		} catch (DAOException e) {
			showExceptionMessage(e);
			e.printStackTrace();
		}
	...
	public List<Mailconfig> getMailSettings() {

		try {
			return mailSettingsDAO.getAll();
		} catch (DAOException e) {
			showExceptionMessage(e);
			e.printStackTrace();
		}
	...
	public void deleteMailSettings(Mailconfig data) {
		try {
			mailSettingsDAO.delete(data);
		} catch (DAOException e) {
			showExceptionMessage(e);
			e.printStackTrace();
		}
	...
	public void insertMailSettings(Mailconfig data) {
		try {
			mailSettingsDAO.insert(data);
		} catch (DAOException e) {
			showExceptionMessage(e);
			e.printStackTrace();
		}
	...
	public void updateMailSettings(Mailconfig data) {
		try {
			mailSettingsDAO.update(data);
		} catch (DAOException e) {
			showExceptionMessage(e);
			e.printStackTrace();
		}
